...
namespace WebAPI.Migrations
{
    ...
    [Migration("20231211133918_update1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthConditionInsuranceProduct", b =>
                {
                    b.Property<Guid>("HealthConditionSourceId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("productSourceId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("HealthConditionSourceId", "productSourceId");
            ...
            modelBuilder.Entity("InsuranceBenefitInsuranceProduct", b =>
                {
                    ...
                    b.HasKey("BenefitsId", "ProductId");

                    b.HasIndex("ProductId");

                    b.ToTable("InsuranceBenefitInsuranceProduct");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "881725d9-5180-4ddb-bb64-0ba1e1f68938",
                            ConcurrencyStamp = "7ea2095f-1bd1-4d98-9299-3e6b1f949cfd",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "7941954e-cb7c-4329-ac91-739b0d9c5978",
                            ConcurrencyStamp = "8d789097-8251-4643-ad0f-068dfa745dbc",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "a2d10c25-f63b-4b1d-a06e-2e0ffe5e62a0",
                            ConcurrencyStamp = "7181bc88-6c19-4c01-8494-42eaf2c5b6a7",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "18accdd6-2852-4881-8d1c-5aa67cb04cbb",
                            ConcurrencyStamp = "74a2ffd5-93d3-4c81-a746-3e0c6263b480",
                            Name = "Employee",
            ...
            modelBuilder.Entity("HealthConditionInsuranceProduct", b =>
                {
                    b.HasOne("Entity.Models.InsuranceModels.HealthCondition", null)
                        .WithMany()
                        .HasForeignKey("HealthConditionSourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InsuranceBenefitInsuranceProduct", b =>
                {
                    b.HasOne("Entity.Models.InsuranceModels.InsuranceBenefit", null)
                        .WithMany()
