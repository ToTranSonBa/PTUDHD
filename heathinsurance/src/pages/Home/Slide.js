    ...
    return (
        <div className="slideshow-container">
            ...
            <div className="mySlides fade" style={{ display: slideIndex === 1 ? 'block' : 'none' }}>
                ...
                <img src={require('../../assets/image/banner-1.jpg')} style={{ width: '100%' }} alt="Slide 1" />
            </div>
            <div className="mySlides fade" style={{ display: slideIndex === 2 ? 'block' : 'none' }}>
                <div className="numbertext">2 / 3</div>
                <img src={require('../../assets/image/banner-2.jpg')} style={{ width: '100%' }} alt="Slide 2" />
            </div>
            <div className="mySlides fade" style={{ display: slideIndex === 3 ? 'block' : 'none' }}>
                <div className="numbertext">3 / 3</div>
                <img src={require('../../assets/image/banner-3.jpg')} style={{ width: '100%' }} alt="Slide 3" />
            </div>
